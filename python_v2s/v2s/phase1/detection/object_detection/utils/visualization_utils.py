...
# changed to work with v2s package structure
from v2s.phase1.detection.object_detection.core import standard_fields as fields
from v2s.phase1.detection.object_detection.utils import shape_utils
